...
const registerdisplaypageRouter = express.Router({mergeParams: true}); // define dishRouter as an express router

registerdisplaypageRouter.use( bodyParser.json());
...
registerdisplaypageRouter.route('/')  //line 18 in index.js specifies dishRouter is assigned to /dishes
.get((req,res, next) => {
...
module.exports = registerdisplaypageRouter;