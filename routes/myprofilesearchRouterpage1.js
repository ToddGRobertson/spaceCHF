...
.get((req,res, next) => {
    ...
    if( req.params.user_id != undefined ){ //someone signed in
        ...
        .then( (data_of_users) => { //dishes is in mongodb as a collection/database
            console.log("inside myprofilesearchRouterpage1 - 34 - data_of_users => " + data_of_users);
            /*
            ...
            */
            res.render('../views/pages/searchpage1', { the_user_id : the_user_id,
        ...
        .then( (data_of_users) => { //dishes is in mongodb as a collection/database
            ...
            console.log("inside myprofilesearchRouter - 40 - data_of_user[0].detailed_description => " + data_of_user[0].detailed_description );
            */
            res.render('../views/pages/searchpage1_no_user_id', {  the_data_of_users : data_of_users }); //title: obj.email 
